...
    fscanf(fptr, "%[^\t]", c);
    int k=0;int flag=0;
    long long int result;int j;long int bal=0;int l=0;
...
    fscanf(fptr, "%[^\t]", c);
    int k=0;int flag=0;
    long long int result;int j;int l=0;
    int a,newpin=0;
    printf("\nEnter the new pin:");
    scanf("%d",&newpin);
    char fbal[10];
...
    fscanf(fptr, "%[^\t]", c);
    int k=0;int flag=0;
    long long int result;int j;long int bal=0;int pin=0,l=0;
    int a,amt;
